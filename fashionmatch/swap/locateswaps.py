...
def genGraph():
  ...
  cur.execute("""SELECT * FROM "User_Has" INNER JOIN "User_Wants" ON "User_Has".articleid = "User_Wants".articleid""")
  edges = cur.fetchall()
  ...
  for row in edges:
    ...
    graph[hasUser].append({"v":int(wantsUser),"HasID":hasID,"WantsID":wantsID})
